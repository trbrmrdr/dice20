...
const ShaderExtras = {
	...
	Additive: {
		uniforms: {
			...
			tAddBloom: { type: "t", value: 1, texture: null },
			fCoeff: { type: "f", value: 1. }
		},
		...
		fragmentShader:
			...
			void main() {
				...
				vec4 add = texture2D( tAdd, uv );
				vec4 addB = texture2D( tAddBloom, uv );
				gl_FragColor = texel + add * fCoeff + addB;
				// gl_FragColor = addB;
				// gl_FragColor = texel;
